...
public class HexConverter {
    ...
    public static String toHex(int goal, int length) { //*
        StringBuilder output = new StringBuilder(toHex(goal)); //gets hex of goal # assigns it to output
    ...
    public static int toInt(String input) //Hex back to Int
    {
        ...
        for (int i = 0; i < input.length(); i++) {
            ...
            switch (input.charAt(i)) {
                ...
                case '8':
                case '9':
                    outArray[i] = input.charAt(i) - 48; //48 = ascii char '0' (number)
                    break;
                case 'A':
                case 'B':
                case 'C':
                ...
                case 'E':
                case 'F':
                    outArray[i] = input.charAt(i) - 55; //55 = ascii char 'A' (letter)
                    break;
            }
        }
